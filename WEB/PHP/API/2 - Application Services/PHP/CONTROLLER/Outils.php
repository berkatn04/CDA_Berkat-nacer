 ...
 *
 * @param integer $valeur => Id de l'element a Selectionner , possedera l'attribut selected
 * 
 ...
 * @return void
 */
function optionSelectAvecFiltres(int $valeur, string $table, array $nomColonnes, string $attributs = "", array $condition = null, string $orderBy = null, $api = false)
{
