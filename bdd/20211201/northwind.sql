...
INSERT INTO `customers` (`id`, `CompanyName`, `ContactName`, `ContactTitle`, `Address`, `City`, `Region`, `PostalCode`, `Country`, `Phone`, `Fax`) VALUES
...
INSERT INTO `orderdetails` (`id`, `ProductID`, `UnitPrice`, `Quantity`, `Discount`) VALUES
...
INSERT INTO `orders` (`id`, `CustomerID`, `EmployeeID`, `OrderDate`, `RequiredDate`, `ShippedDate`, `ShipVia`, `Freight`, `ShipName`, `ShipAddress`, `ShipCity`, `ShipRegion`, `ShipPostalCode`, `ShipCountry`) VALUES
...
(1, 'rthr', 1, 1, '10 boxes x 20 bags', '18.0000', 39, 0, 10, 0),
...
(78, 'ergerg', 2, 2, '2', '7527.0000', 4, 3, 6, 5),
(79, 'ergerg', 2, 2, '2', '7527.0000', 4, 3, 6, 5),
(80, 'yrs', 3, 3, '3', '72.0000', 5, 5, 2, 4);
...
ALTER TABLE `orderdetails`
  ADD CONSTRAINT `orderdetails_ibfk_1` FOREIGN KEY (`id`) REFERENCES `orders` (`id`),
...
ALTER TABLE `products`
  ADD CONSTRAINT `products_ibfk_1` FOREIGN KEY (`supplier_id_id`) REFERENCES `suppliers` (`id`);
COMMIT;
