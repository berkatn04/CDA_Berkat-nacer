...
CREATE TABLE `achemine` (
  ...
  KEY `FK_Achemine_CentreTri` (`idCentresDeTri`),
  CONSTRAINT `FK_Achemine_Bureaux` FOREIGN KEY (`idBureau`) REFERENCES `bureaux` (`idBureau`),
  CONSTRAINT `FK_Achemine_CentreTri` FOREIGN KEY (`idCentresDeTri`) REFERENCES `centres_de_tri` (`idCentresDeTri`),
  CONSTRAINT `FK_Achemine_Transports` FOREIGN KEY (`idTransport`) REFERENCES `transports` (`idTransport`)
...
-- Dump completed on 2021-10-13 17:20:00
